...
server <- function(input, output, session) {
  ...
  ## 2.2 Make the list with codes which should be monitored reactive
  
  # Initialize the list with chemicals which should be monitored
  ...
  # Remove a chemical from the list
  ...
  # Remove added chemicals from the list
  ...
  # Add the codes from the uploaded file to the list
  ...
  # Update the names from the chemicals which have been added before the production data was uploaded
  ...
  ## 2.3 Clean and analyse input data and update input options based on the data
  
  # Clean the total prodcution data
  eu_data<-reactive({
  ...
  # Clean the production data for the single countries
  ...
  # Import the geojson containing the borders of the countries
  ...
  # Function to calculate the country based on the lat and lon coordinates
  ...
  # Determine the country which was clicked on
  ...
  # Clean data for the leaflet map
  export_map<-reactive({
    leaflet(countries()) %>%
  ...
  # Clean the production data for the plots and the map
  prd<-reactive({
  ...
  # Update the years which can be selected for the plotting function and clean the production data
  observe({
    input_data<-input$sav
  ...
  # Update the choices of chemicals which can be selected for the plotting function
  observe({
  ...
  ## 2.4 Render plots, tables and text
  
  # Table displaying the selected chemicals based on their code
  output$list<-renderDataTable({
    prcodes$codes
  })
  
  # Help text for the add, remove and reset function for the list
  ...
  # Help text for displaying the plots of the total production in single countries when clicking on the map
  output$info<-renderText({
    "The plot for the country you click on will be displayed here"
  })
  
  # Trend of total production of selected chemicals in selected countries
  ...
  # Total production of single countries and the whole European Union over the whole study period
  ...
  # Total production in the different countries summed up over the whole time period for the selected substance(s)
  ...
  # Trend of the total production in the European Union with different number of member states
  ...
  ## 2.5 Download handler for tables, plots and the map
  
  # Plot of the trend of total production of selected chemicals in selected countries
  ...
  # Data of the Plot of the trend of total production of selected chemicals in selected countries
  ...
  # Plot of the trend of the total production in the European Union with different number of member states
  ...
  # Data of the plot of the trend of the total production in the European Union with different number of member states
  ...
  # Map of the total production in the different countries summed up over the whole time period for the selected substance(s)
  ...
  # Boxplot of the total production of single countries and the whole European Union over the whole study period
  ...
  # Data of the boxplot of the total production of single countries and the whole European Union over the whole study period
